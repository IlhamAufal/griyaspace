                    ...
                    <div>
                        ...
                        <h2 class="mb-4 text-xs uppercase flex leading-[20px] text-gray-400"
                            ...
                            <template x-if="!$store.sidebar.isExpanded && !$store.sidebar.isHovered && !$store.sidebar.isMobileOpen">
                                <i class="fa-solid fa-ellipsis text-gray-400 text-sm"></i>
                            </template>
                        </h2>
                                    ...
                                    @if (isset($item['subItems']))
                                        ...
                                        <button @click="toggleSubmenu({{ $groupIndex }}, {{ $itemIndex }})"
                                            ...
                                            <span :class="isSubmenuOpen({{ $groupIndex }}, {{ $itemIndex }}) ?
                                                ...
                                                <i class="w-6 text-center text-lg {{ MenuHelper::getIconClass($item['icon']) }}"></i>
                                            </span>
                                            ...
                                            <!-- Chevron Down Icon -->
                                            <i x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered || $store.sidebar.isMobileOpen"
                                                class="fa-solid fa-chevron-down ml-auto text-sm transition-transform duration-200"
                                                :class="{
